  ...
  <div class="flex flex-wrap justify-center max-w-screen-2xl m-auto">
    <TransitionGroup
      ...
      <div class="relative overflow-hidden pb-[125%] rounded-[32px]">
        ...
        <NuxtLink class="absolute inset-0 bg-gradient-to-t from-black/50 hover:from-black/60 flex items-end p-5" :to="localePath(`/product/${product.slug}-${product.sku.split('-')[0]}`)">
